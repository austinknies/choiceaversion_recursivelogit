%% Figure 11(B) from Knies, Lorca, and Melo (2021)
% Calculates welfare for Figures 8(A) and 8(B) using the 
...
save('Figure11B.mat','Wadaptive','-append')
