%% Figure 9(A) from Knies and Melo (2020)
% Calculates welfare for Figures 7(A) and 7(B) using the choice aversion
% model for varying kappa at particular values of x

%% Welfare for Figure 7(A)
...
save Figure9A.mat Welfarebefore
...
save('Figure9A.mat','Welfareafter','-append')
