%% Part 2 - Figure 8 from Knies and Melo (2020)
% MUST RUN AFTER FIGURE8PART1.M (otherwise will not have proper .mat file)
...
save('Figure8part2.mat','Wca5','-append')
% % Plots route choice probabilities
% figure
% p = plot(x,P1,x,P2,x,P3);
% p(1).LineWidth = 2;
...
save('Figure8part2.mat','Wmnl','-append')
...
save('Figure8part2.mat','Wpsl','-append')
...
save('Figure8part2.mat','Waltpsl','-append')
...
save('Figure8part2.mat','Wgpsl','-append')
...
save('Figure8part2.mat','Waltgpsl','-append')
...
save('Figure8part2.mat','Wadaptive','-append')
