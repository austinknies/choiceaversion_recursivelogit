%% Part 1 - Figure 10 from Knies, Lorca, and Melo (2021)
% MUST RUN BEFORE FIGURE10PART2.M (otherwise will not have proper .mat file)
...
save('Figure10part1.mat','Vca5','-append')
% % plots route choice probabilities
% figure
% p = plot(x,P1,x,P2);
% p(1).LineWidth = 2;
...
save('Figure10part1.mat','Vmnl','-append')
...
save('Figure10part1.mat','Vpsl','-append')
...
save('Figure10part1.mat','Valtpsl','-append')
...
save('Figure10part1.mat','Vgpsl','-append')
...
save('Figure10part1.mat','Valtgpsl','-append')
...
save('Figure10part1.mat','Vadaptive','-append')
