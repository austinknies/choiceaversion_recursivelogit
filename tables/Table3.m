...
%% Table 3 from Knies, Lorca, and Melo (2021)
% Calculates route choice probabilities for Figure 7
% Produces Table 3, Column 2
...
Prob = zeros(6,5);
Prob(:,1) = P;
save Table3.mat Prob

%% Table 3 from Knies, Lorca, and Melo (2021)
% Calculates route choice probabilities for Figure 7
% Produces Table 3, Column 3
% Network originally featured in Mai et al. (2015) (Figure 3)
% Choice Aversion Model (Heterogeneous/Node-Specific Choice Aversion Parameter Extension)
